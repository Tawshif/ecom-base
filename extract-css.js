...
const blocks = cssContent.split(/\/\* ={60}\n\s+([A-Z0-9 &()—]+)\n\s+={60} \*\//);

// blocks[0] is everything before the first comment (if any)
// blocks[1] is the name of the first section
// blocks[2] is the content of the first section
// ...
